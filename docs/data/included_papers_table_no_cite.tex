...
\hline
    \small\raggedright Daniele and Luciano (2022) & Knowledge Enhanced Neural Networks for relational domains & Paper extends knowledge enhanced NNs to handle relational data and shows that stacking multiple KE layers deals with rule dependencies, achieving better accuracy than baseline NNS on Citeseer citation network classification while also being faster than baseline Semantic Based Regularization (SBR) and Relational Neural Machines (RNM) \\
\hline
